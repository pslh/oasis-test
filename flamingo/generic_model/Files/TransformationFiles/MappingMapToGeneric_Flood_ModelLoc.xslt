...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:vmf="http://www.altova.com/MapForce/UDF/vmf" xmlns:agt="http://www.altova.com/Mapforce/agt" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="vmf agt xs">
	...
	<xsl:template name="agt:MapToGeneric_Flood_ModelLoc_var47_create_rec">
		...
		<rec>
			...
			<xsl:variable name="var25_FLCVVAL">
				<xsl:if test="$var46_current/@FLCV1VAL">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:variable name="var26_resultof_vmf__inputtoresult">
				<xsl:call-template name="vmf:vmf1_inputtoresult">
					<xsl:with-param name="input" select="(string($var46_current/@FLCV1VAL) &gt; string('0'))"/>
				</xsl:call-template>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var25_FLCVVAL))) != 'false'">
				<xsl:attribute name="COV1">
					<xsl:value-of select="string($var26_resultof_vmf__inputtoresult)"/>
				</xsl:attribute>
			</xsl:if>
			<xsl:variable name="var27_FLCVVAL">
				<xsl:if test="$var46_current/@FLCV2VAL">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:variable name="var28_resultof_vmf__inputtoresult">
				<xsl:call-template name="vmf:vmf2_inputtoresult">
					<xsl:with-param name="input" select="(string($var46_current/@FLCV2VAL) &gt; string('0'))"/>
				</xsl:call-template>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var27_FLCVVAL))) != 'false'">
				<xsl:attribute name="COV2">
					<xsl:value-of select="string($var28_resultof_vmf__inputtoresult)"/>
				</xsl:attribute>
			</xsl:if>
			<xsl:variable name="var29_FLCVVAL">
				<xsl:if test="$var46_current/@FLCV3VAL">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:variable name="var30_resultof_vmf__inputtoresult">
				<xsl:call-template name="vmf:vmf3_inputtoresult">
					<xsl:with-param name="input" select="(string($var46_current/@FLCV3VAL) &gt; string('0'))"/>
				</xsl:call-template>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var29_FLCVVAL))) != 'false'">
				<xsl:attribute name="COV3">
					<xsl:value-of select="string($var30_resultof_vmf__inputtoresult)"/>
				</xsl:attribute>
			</xsl:if>
			<xsl:variable name="var31_FLCVVAL">
				<xsl:if test="$var46_current/@FLCV4VAL">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:variable name="var32_resultof_vmf__inputtoresult">
				<xsl:call-template name="vmf:vmf4_inputtoresult">
					<xsl:with-param name="input" select="(string($var46_current/@FLCV4VAL) &gt; string('0'))"/>
				</xsl:call-template>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var31_FLCVVAL))) != 'false'">
				<xsl:attribute name="COV4">
					<xsl:value-of select="string($var32_resultof_vmf__inputtoresult)"/>
				</xsl:attribute>
			</xsl:if>
			<xsl:variable name="var33_FLCVVAL">
				<xsl:if test="$var46_current/@FLCV5VAL">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:variable name="var34_resultof_vmf__inputtoresult">
				<xsl:call-template name="vmf:vmf5_inputtoresult">
					<xsl:with-param name="input" select="(string($var46_current/@FLCV5VAL) &gt; string('0'))"/>
				</xsl:call-template>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var33_FLCVVAL))) != 'false'">
				<xsl:attribute name="COV5">
					<xsl:value-of select="string($var34_resultof_vmf__inputtoresult)"/>
				</xsl:attribute>
			</xsl:if>
			<xsl:variable name="var35_FLCVVAL">
				<xsl:if test="$var46_current/@FLCV6VAL">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:variable name="var36_resultof_vmf__inputtoresult">
				<xsl:call-template name="vmf:vmf6_inputtoresult">
					<xsl:with-param name="input" select="(string($var46_current/@FLCV6VAL) &gt; string('0'))"/>
				</xsl:call-template>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var35_FLCVVAL))) != 'false'">
				<xsl:attribute name="COV6">
					<xsl:value-of select="string($var36_resultof_vmf__inputtoresult)"/>
				</xsl:attribute>
			</xsl:if>
			<xsl:variable name="var37_FLCVVAL">
				<xsl:if test="$var46_current/@FLCV7VAL">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:variable name="var38_resultof_vmf__inputtoresult">
				<xsl:call-template name="vmf:vmf7_inputtoresult">
					<xsl:with-param name="input" select="(string($var46_current/@FLCV7VAL) &gt; string('0'))"/>
				</xsl:call-template>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var37_FLCVVAL))) != 'false'">
				<xsl:attribute name="COV7">
					<xsl:value-of select="string($var38_resultof_vmf__inputtoresult)"/>
				</xsl:attribute>
			</xsl:if>
			<xsl:variable name="var39_FLCVVAL">
				<xsl:if test="$var46_current/@FLCV8VAL">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:variable name="var40_resultof_vmf__inputtoresult">
				<xsl:call-template name="vmf:vmf8_inputtoresult">
					<xsl:with-param name="input" select="(string($var46_current/@FLCV8VAL) &gt; string('0'))"/>
				</xsl:call-template>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var39_FLCVVAL))) != 'false'">
				<xsl:attribute name="COV8">
					<xsl:value-of select="string($var40_resultof_vmf__inputtoresult)"/>
				</xsl:attribute>
			</xsl:if>
			<xsl:variable name="var41_FLCVVAL">
				<xsl:if test="$var46_current/@FLCV9VAL">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:variable name="var42_resultof_vmf__inputtoresult">
				<xsl:call-template name="vmf:vmf9_inputtoresult">
					<xsl:with-param name="input" select="(string($var46_current/@FLCV9VAL) &gt; string('0'))"/>
				</xsl:call-template>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var41_FLCVVAL))) != 'false'">
				<xsl:attribute name="COV9">
					<xsl:value-of select="string($var42_resultof_vmf__inputtoresult)"/>
				</xsl:attribute>
			</xsl:if>
			<xsl:variable name="var43_FLCVVAL">
				<xsl:if test="$var46_current/@FLCV10VAL">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:variable name="var44_resultof_vmf___inputtoresult">
				<xsl:call-template name="vmf:vmf10_inputtoresult">
					<xsl:with-param name="input" select="(string($var46_current/@FLCV10VAL) &gt; string('0'))"/>
				</xsl:call-template>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var43_FLCVVAL))) != 'false'">
				<xsl:attribute name="COV10">
					<xsl:value-of select="string($var44_resultof_vmf___inputtoresult)"/>
				</xsl:attribute>
			</xsl:if>
			<xsl:variable name="var45_BASEMENT">
				<xsl:if test="$var46_current/@BASEMENT">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var45_BASEMENT))) != 'false'">
				<xsl:attribute name="BASEMENT">
					<xsl:value-of select="string($var46_current/@BASEMENT)"/>
				</xsl:attribute>
			</xsl:if>
		</rec>
	</xsl:template>
	<xsl:template name="agt:MapToGeneric_Flood_ModelLoc_var49_resultof_map">
		<xsl:param name="var48_current"/>
		<xsl:for-each select="$var48_current/rec">
			<xsl:call-template name="agt:MapToGeneric_Flood_ModelLoc_var47_create_rec">
	...
	<xsl:template match="/">
		<root>
			<xsl:attribute name="xsi:noNamespaceSchemaLocation" namespace="http://www.w3.org/2001/XMLSchema-instance">C:/Users/Administrator/Desktop/git/cookiecutter-OasisModel/gemoasismodel/flamingo/generic_model/ValidationFiles/Generic_Flood_ModelLoc.xsd</xsl:attribute>
			<xsl:for-each select="root">
				<xsl:call-template name="agt:MapToGeneric_Flood_ModelLoc_var49_resultof_map">
